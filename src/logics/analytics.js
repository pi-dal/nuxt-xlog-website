...
class AnalyticsManager {
    ...
    // Usage tracking
    trackUsage(feature, action, metadata) {
        const usage = {
            feature,
            action,
            timestamp: Date.now(),
...
export function trackPerformance(operation, duration, success, options) {
...
export function trackUsage(feature, action, metadata) {
    analytics.trackUsage(feature, action, metadata);
}
// Enhanced performance wrapper that includes analytics
export async function withAnalytics(operation, fn) {
