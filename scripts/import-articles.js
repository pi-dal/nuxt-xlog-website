...
function rewriteAssetLinks(slug, body) {
...
function toFrontmatter(record, body) {
...
async function copyAssetDirectory(slug, sourceMarkdownPath, publicDir) {
...
function createImportedRecord(row, parsed) {
